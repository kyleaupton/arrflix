...
backend/internal/parsing/
  ...
  quality.go      // resolution / source / bin             (from internal/release)
...
| Area                                   | Status                                                              |
| -------------------------------------- | ------------------------------------------------------------------- |
| Quality (resolution/source/bin/remux)  | **Done** — `internal/release/`, Sonarr-parity-tested                |
...
| **[Metadata](../metadata/README.md)**                 | Matching turns parsing's identity hints into resolved `Media` via the metadata/external-id layer.                              |
