 ...
 * Sets per-segment acquisition autonomy (backfill and ongoing) to 'auto' or 'manual', holding or releasing the segment's live wants to match. 'propose' is not yet accepted.
 */
