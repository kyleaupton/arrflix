 ...
 */
export const authAcceptInvite = <ThrowOnError extends boolean = false>(options: Options<AuthAcceptInviteData, ThrowOnError>) => {
    return (options.client ?? client).post<AuthAcceptInviteResponses, AuthAcceptInviteErrors, ThrowOnError>({
 ...
 */
export const sessionsRevokeAll = <ThrowOnError extends boolean = false>(options?: Options<SessionsRevokeAllData, ThrowOnError>) => {
    return (options?.client ?? client).delete<SessionsRevokeAllResponses, SessionsRevokeAllErrors, ThrowOnError>({
...
export const sessionsList = <ThrowOnError extends boolean = false>(options?: Options<SessionsListData, ThrowOnError>) => {
    return (options?.client ?? client).get<SessionsListResponses, SessionsListErrors, ThrowOnError>({
        url: '/api/v1/auth/sessions',
        ...options
    });
};
 ...
 */
export const sessionsRevoke = <ThrowOnError extends boolean = false>(options: Options<SessionsRevokeData, ThrowOnError>) => {
    return (options.client ?? client).delete<SessionsRevokeResponses, SessionsRevokeErrors, ThrowOnError>({
 ...
 */
export const titleStatusGet = <ThrowOnError extends boolean = false>(options: Options<TitleStatusGetData, ThrowOnError>) => {
    return (options.client ?? client).get<TitleStatusGetResponses, TitleStatusGetErrors, ThrowOnError>({
