 ...
 */
export const pushUnsubscribe = <ThrowOnError extends boolean = false>(options: Options<PushUnsubscribeData, ThrowOnError>) => {
    return (options.client ?? client).delete<PushUnsubscribeResponses, PushUnsubscribeErrors, ThrowOnError>({
