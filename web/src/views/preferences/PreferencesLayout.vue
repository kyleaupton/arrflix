...
// admin-only Settings layout) the nav has no capability gates. One unlabeled
// group renders as a flat section list.
...
<template>
  <SidebarLayout title="Preferences" base-path="/preferences" :groups="groups" />
</template>
