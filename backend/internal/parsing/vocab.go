...
var seriesBins = []Bin{
	// Quality.cs:78 — SDTV
	{Name: "SDTV", Source: SourceTV, Resolution: Res480p, Modifier: ModNone},
	// Quality.cs:79 — DVD
	{Name: "DVD", Source: SourceDVD, Resolution: Res480p, Modifier: ModNone},
	// Quality.cs:90 — WEBRip-480p
	{Name: "WEBRip-480p", Source: SourceWEBRip, Resolution: Res480p, Modifier: ModNone},
	// Quality.cs:85 — WEBDL-480p
	{Name: "WEBDL-480p", Source: SourceWEBDL, Resolution: Res480p, Modifier: ModNone},
	// Quality.cs:95 — Bluray-480p
	{Name: "Bluray-480p", Source: SourceBluRay, Resolution: Res480p, Modifier: ModNone},
	// Quality.cs:100 — Bluray-576p
	{Name: "Bluray-576p", Source: SourceBluRay, Resolution: Res576p, Modifier: ModNone},
	// Quality.cs:81 — HDTV-720p
	{Name: "HDTV-720p", Source: SourceTV, Resolution: Res720p, Modifier: ModNone},
	// Quality.cs:105 — WEBRip-720p
	{Name: "WEBRip-720p", Source: SourceWEBRip, Resolution: Res720p, Modifier: ModNone},
	// Quality.cs:82 — WEBDL-720p
	{Name: "WEBDL-720p", Source: SourceWEBDL, Resolution: Res720p, Modifier: ModNone},
	// Quality.cs:83 — Bluray-720p
	{Name: "Bluray-720p", Source: SourceBluRay, Resolution: Res720p, Modifier: ModNone},
	// Quality.cs:84 — Bluray-1080p
	{Name: "Bluray-1080p", Source: SourceBluRay, Resolution: Res1080p, Modifier: ModNone},
	// Quality.cs:86 — HDTV-1080p
	{Name: "HDTV-1080p", Source: SourceTV, Resolution: Res1080p, Modifier: ModNone},
	// Quality.cs:110 — WEBRip-1080p
	{Name: "WEBRip-1080p", Source: SourceWEBRip, Resolution: Res1080p, Modifier: ModNone},
	// Quality.cs:80 — WEBDL-1080p
	{Name: "WEBDL-1080p", Source: SourceWEBDL, Resolution: Res1080p, Modifier: ModNone},
	...
	{Name: "Raw-HD", Source: SourceTV, Resolution: Res1080p, Modifier: ModRawHD},
	// Quality.cs:115 — HDTV-2160p
	{Name: "HDTV-2160p", Source: SourceTV, Resolution: Res2160p, Modifier: ModNone},
	// Quality.cs:116 — WEBRip-2160p
	{Name: "WEBRip-2160p", Source: SourceWEBRip, Resolution: Res2160p, Modifier: ModNone},
	// Quality.cs:121 — WEBDL-2160p
	{Name: "WEBDL-2160p", Source: SourceWEBDL, Resolution: Res2160p, Modifier: ModNone},
	// Quality.cs:122 — Bluray-2160p
	{Name: "Bluray-2160p", Source: SourceBluRay, Resolution: Res2160p, Modifier: ModNone},
	// Quality.cs:123 — Bluray-1080p Remux (QualitySource.BlurayRaw in Sonarr;
	// orthogonal core (BluRay, 1080p, REMUX)).
	{Name: "Bluray-1080p Remux", Source: SourceBluRay, Resolution: Res1080p, Modifier: ModRemux},
	// Quality.cs:124 — Bluray-2160p Remux (QualitySource.BlurayRaw; orthogonal
	// core (BluRay, 2160p, REMUX)).
	{Name: "Bluray-2160p Remux", Source: SourceBluRay, Resolution: Res2160p, Modifier: ModRemux},
}
...
var movieBins = []Bin{
	...
	{Name: "WORKPRINT", Source: SourceWorkprint, Resolution: ResUnknown, Modifier: ModNone},
	// Quality.cs:84 — CAM
	{Name: "CAM", Source: SourceCAM, Resolution: ResUnknown, Modifier: ModNone},
	// Quality.cs:85 — TELESYNC
	{Name: "TELESYNC", Source: SourceTelesync, Resolution: ResUnknown, Modifier: ModNone},
	// Quality.cs:86 — TELECINE
	{Name: "TELECINE", Source: SourceTelecine, Resolution: ResUnknown, Modifier: ModNone},
	// Quality.cs:87 — DVDSCR (Modifier.SCREENER; deferred in parsing)
	{Name: "DVDSCR", Source: SourceDVD, Resolution: Res480p, Modifier: ModScreener},
	// Quality.cs:88 — REGIONAL (Modifier.REGIONAL; deferred in parsing)
	{Name: "REGIONAL", Source: SourceDVD, Resolution: Res480p, Modifier: ModRegional},
	// Quality.cs:91 — SDTV
	{Name: "SDTV", Source: SourceTV, Resolution: Res480p, Modifier: ModNone},
	// Quality.cs:92 — DVD (resolution 0 in Radarr; the plain-DVD bin is
	// resolution-agnostic, see engine.findBySourceAndResolution).
	{Name: "DVD", Source: SourceDVD, Resolution: ResUnknown, Modifier: ModNone},
	// Quality.cs:93 — DVD-R (Modifier.REMUX at DVD/480p).
	{Name: "DVD-R", Source: SourceDVD, Resolution: Res480p, Modifier: ModRemux},
	...
	{Name: "Remux-1080p", Source: SourceBluRay, Resolution: Res1080p, Modifier: ModRemux},
	// Quality.cs:114 — Remux-2160p (Modifier.REMUX at BLURAY/2160p)
	{Name: "Remux-2160p", Source: SourceBluRay, Resolution: Res2160p, Modifier: ModRemux},
	// Quality.cs:116 — BR-DISK (Modifier.BRDISK at BLURAY/1080p)
	{Name: "BR-DISK", Source: SourceBluRay, Resolution: Res1080p, Modifier: ModBRDisk},
